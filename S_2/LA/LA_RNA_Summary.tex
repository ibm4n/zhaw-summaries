...
\begin{multicols*}{3}
    ...
    \circled{3} Unterste Zeile $\to $ nur eine führenden 1 in der untersten Zeile und einer Zahl im Lösungsvektor $=$ Zahl als Parameter in Gerade einsetzen.\\
    \WhiteSpace
    ...
    {\includegraphics[scale=0.675]{tabelle_spiegelung.png}}
